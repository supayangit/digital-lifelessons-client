...
export default function PublicLessonsClient() {
  ...
  const sortQueryParams = useMemo(() => {
    switch (sort) {
      ...
      case 'most-saved':
        return { sortBy: 'favoritesCount', order: 'desc' }
      default:
  ...
  const sortedLessons = useMemo(() => {
    return [...lessons].sort((a, b) => {
      ...
      switch (sort) {
        ...
        case 'most-saved':
          return (b.favoritesCount ?? b.savesCount ?? 0) - (a.favoritesCount ?? a.savesCount ?? 0)
        case 'newest':
        default:
          return bDate - aDate
      }
